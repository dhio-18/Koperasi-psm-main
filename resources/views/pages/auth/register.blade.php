        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div x-data="{ show: false }" class="relative">
                <input :type="show ? 'text' : 'password'" name="password_confirmation" id="password_confirmation"
                    ...
                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-200 @error('password_confirmation') border-red-500 @enderror"
                    required>
                ...
                <button type="button" @click="show = !show"
                    ...
                    <svg x-show="show" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.956 9.956 0 012.642-3.826M9.88 9.88a3 3 0 104.24 4.24M6.228 6.228A9.956 9.956 0 002.458 12C3.732 16.057 7.523 19 12 19c2.03 0 3.918-.607 5.472-1.646M17.772 17.772A9.956 9.956 0 0021.542 12C20.268 7.943 16.477 5 12 5c-1.537 0-2.987.348-4.272.968" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18" />
                    </svg>
                </button>
            </div>
