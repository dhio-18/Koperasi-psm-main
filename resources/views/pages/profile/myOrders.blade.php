                        ...
                        <div x-show="order.auto_confirmed"
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-green-700" x-text="'Pesanan dikonfirmasi secara otomatis'">
                                    </p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <template x-for="(history, index) in order.histories" :key="index">
                                                <div class="relative pb-4">
                                                    ...
                                                    <div class="flex flex-col gap-1">
                                                        ...
                                                        <p class="text-sm text-gray-700  whitespace-pre-line" x-text="history.description">
                                                        </p>
