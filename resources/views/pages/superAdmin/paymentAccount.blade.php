...
@section('main')
    <div class="bg-gray-50 min-h-screen">
        <div x-data="paymentAccountManager()" class="container mx-auto px-4 py-8">
                ...
                <div class="overflow-x-auto w-full">
                    <table class="w-full text-sm md:text-base">
                        <thead class="bg-green-50">
                            <tr>
                                <th
                                    class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-green-800 uppercase tracking-wider">
                                    Nama Bank</th>
                                <th
                                    class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-green-800 uppercase tracking-wider">
                                    Nomor Rekening</th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                        <template x-if="account.qr_code_url">
                                            <img :src="account.qr_code_url" alt="QR"
                                                class="h-10 w-10 sm:h-12 sm:w-12 rounded border object-cover">
                                        </template>
                                        <template x-if="!account.qr_code_url">
                                    ...
                                    <td
                                        class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 flex items-center justify-start">
            ...
            <div x-show="showModal" x-transition:enter="transition ease-out duration-400"
                ...
                <div x-show="showModal" x-transition:enter="transition ease-out duration-400 delay-75"
            ...
            <div x-show="showDeleteModal" x-transition:enter="transition ease-out duration-400"
                ...
                class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-2 sm:p-0"
                style="display:none; backdrop-filter: blur(4px);">
                <div x-show="showDeleteModal" x-transition:enter="transition ease-out duration-400 delay-75"
                    x-transition:enter-start="opacity-0 scale-90 translate-y-8"
                    x-transition:enter-end="opacity-100 scale-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-300"
                    x-transition:leave-start="opacity-100 scale-100 translate-y-0"
