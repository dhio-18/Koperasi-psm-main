...
class CarouselImageSeeder extends Seeder
{
    ...
    {
        // Cek apakah sudah ada data untuk menghindari duplikas
        ...
        $carouselImages = [
            [
                'image_path' => 'CarouselI/slider1.jpg',
                'order' => 1,
                'is_active' => true,
            ],
            [
                'image_path' => 'CarouselI/slider2.jpg',
                'order' => 2,
                'is_active' => true,
            ],
            [
                'image_path' => 'CarouselI/slider3.jpg',
                'order' => 3,
                'is_active' => true,
            ],
            [
                'image_path' => 'CarouselI/slider4.jpg',
                'order' => 4,
                'is_active' => true,
            ],
        ];
